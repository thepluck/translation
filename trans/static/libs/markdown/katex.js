...
var fontMap = {
    ...
    // "mathit" is missing because it requires the use of two katex-fonts: Main-Italic
...
groupTypes.op = function(group, options) {
    ...
    if (group.value.symbol) {
        ...
        // appears that our katex-fonts have the centers of the symbols already
...
groupTypes.accent = function(group, options) {
    ...
    // The \vec character that the katex-fonts use is a combining character, and
 ...
 * Size2, Size3, or Size4 katex-fonts. `makeStackedDelim` makes a delimiter out of
 ...
 * Size3, or Size4 katex-fonts. It is always rendered in textstyle.
 */
...
function symbolNode(value, height, depth, italic, skew, classes, style) {
    ...
    // katex-fonts to use.  This allows us to render these characters with a serif
    // font in situations where the browser would either default to a sans serif
    // or render a placeholder character.
    if (unicodeRegexes.cjkRegex.test(value)) {
        // I couldn't find any katex-fonts that contained Hangul as well as all of
...
/**
 * This file contains metrics regarding katex-fonts and individual symbols. The sigma
...
//
// The font metrics are stored in katex-fonts cmsy10, cmsy7, and cmsy5 respsectively.
...
// parameters of the extension katex-fonts (family 3). See the TeXbook, page 441.
var xi1 = 0;
var xi2 = 0;
var xi3 = 0;
var xi4 = 0;
 ...
 * - font (required): the font to be used for this symbol. Either "main" (the
     normal font), or "ams" (the ams katex-fonts).
